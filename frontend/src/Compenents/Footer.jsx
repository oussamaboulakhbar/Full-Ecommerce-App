        ...
        <footer className="bg-green-700 text-white">
            <div className="container mx-auto px-4 py-8">
                <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
                    <div>
                        <h3 className="text-lg font-bold mb-4 text-red-600">Company</h3>
                        <ul>
                    ...
                    <div>
                        <h3 className="text-lg font-bold mb-4 text-red-600">Our Product</h3>
                        <ul>
                    ...
                    <div>
                        <h3 className="text-lg font-bold mb-4 text-red-600">Other Product</h3>
                        <ul>
                    ...
                    <div>
                        <h3 className="text-lg font-bold mb-4 text-red-600">Legal</h3>
                        <ul>
                    ...
                    <div>
                        <h3 className="text-lg font-bold mb-4 text-red-600">Information</h3>
                        <ul>
