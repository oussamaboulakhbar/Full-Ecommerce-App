                        ...
                        return (
                            <Link key={product?._id} to={"/product/"+product?._id}className='w-full min-w-[280px]  md:min-w-[292px] max-w-[280px] md:max-w-[292px]  bg-white rounded-lg shad '>
                                ...
                                <div className='p-4 grid gap-3'>
                                    ...
                                    <button className='text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg z-30 text-sm px-5 py-2.5 text-center me-2' onClick={(e) => handleAddToCart(e, product?._id)}>Add to Cart</button>
                                </div>
                            </Link>
                        )
                    })
